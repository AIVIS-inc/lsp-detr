...
class CocoDetection(torchvision.datasets.CocoDetection, DetDataset):
    ...
    def __init__(
        ...
        # Print basic dataset info (detailed crop statistics handled by MultiCropDatasetWrapper if used)
        print(f"[CocoDetection] Dataset loaded: {len(self.ids)} images from {ann_file}")
